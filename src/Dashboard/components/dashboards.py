...
layout = dbc.Col([
        dbc.Row([
            ...
            dbc.Col([
                    dbc.CardGroup([
                            dbc.Card([
                                    html.Legend("Consumo de Energia"),
            ...
            dbc.Col([
                    dbc.CardGroup([
                            dbc.Card([
                                    html.Legend("Economia de Energia"),
            ...
            dbc.Col([
                dbc.CardGroup([
                    ...
                    dbc.Card(
                        html.Div(className="fa fa-minus-square-o", style=card_icon), 
                        color="danger",
                        style={"maxWidth": 75, "height": 100, "margin-left": "-10px"},
                    )])
                ], width=4),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                        ...
                        html.Label("Categorias", style={"margin-top": "10px"}),
                        dcc.Dropdown(
                            id="dropdown-despesa",
                            clearable=False,
                            style={"width": "100%"},
